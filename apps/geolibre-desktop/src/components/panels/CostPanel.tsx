...
export function CostPanel(): ReactElement | null {
  ...
  return (
    <aside
      ...
      className="relative flex max-h-[min(34rem,75vh)] supports-[max-height:1dvh]:max-h-[min(34rem,75dvh)] w-full shrink-0 flex-col items-center justify-center gap-3 overflow-hidden border-t bg-card p-6 text-center max-md:fixed max-md:inset-x-0 max-md:bottom-16 max-md:z-30 max-md:shadow-xl md:max-h-none md:w-96 md:border-l md:border-t-0"
    >
